...
public class InFaceUV {
    ...
    public void prepare(Pair<Float, Float> texture) {
        realU1 = texture.getKey() + u1 * MainWindow.getRenderer().getModelLoader().getTextureLoader().getStep()
                / texturePackRes;
        realU2 = texture.getKey() + u2 * MainWindow.getRenderer().getModelLoader().getTextureLoader().getStep()
                / texturePackRes;
